...
<ProsCons
  pros={[
    "Notion: perfecta para documentar procesos, manuales y bases de conocimiento",
    "ClickUp: gestión de tareas muy completa con dependencias, seguimiento de tiempo y sprints",
