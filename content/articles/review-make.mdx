...
<ProsCons
  pros={[
    "Integra 1.700+ apps con Holded: sincroniza facturación, emails y mensajería sin código manual",
    "El plan gratuito sirve para probar en serio: 1.000 operaciones al mes",
    "Visualiza cada automatización en tiempo real: entiendes qué sucede en tus procesos sin sorpresas",
    "Más económico que Zapier: optimiza presupuesto de automatización para operaciones medianas"
  ]}
  cons={[
    ...
    "Alertas automáticas 24/7: Detecta fallos nocturnos antes de que afecten tus operaciones diarias"
  ]}
/>
