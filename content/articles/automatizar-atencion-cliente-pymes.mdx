...
<ProsCons
  pros={[
    "Zapier conecta más de 7.000 aplicaciones — si usas una herramienta, casi seguro tiene integración",
    "Make permite flujos visuales complejos a menor coste para volúmenes altos",
