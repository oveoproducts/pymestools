...
<ProsCons
  pros={[
    "Ahorra horas sin ampliar nómina: automatiza publicaciones y evita contratar community manager",
    "Zapier vs Make según complejidad: elige Zapier para empezar, Make para flujos avanzados",
    "Integra Buffer, Hootsuite, LinkedIn e Instagram: conecta todas tus redes en un solo lugar",
    "Prueba gratis sin compromiso: valida si la automatización funciona en tu negocio"
  ]}
  cons={[
    "Limitaciones Instagram Meta: No automatiza todas las acciones que necesitas por restricciones de plataforma.",
    "Sin alertas automáticas: Los fallos nocturnos pasan desapercibidos sin configurar notificaciones manuales."
  ]}
/>
